...
"...", "payeeIban": "...", "amount": 0, "currency": "...", "issueDate":
"YYYY-MM-DD", "dueDate": "YYYY-MM-DD", "vatAmount": 0, "confidence": 0}`, waarbij
`amount` het totaalbedrag incl. btw is, `vatAmount` en `payeeIban` je weglaat
als ze er niet staan, en `confidence` je eigen zekerheid is (0..1).
