...
const STATIC: BankNlTable = {
  ...
  rows: [
    { bank: "ABN AMRO", card: "betaalpas", fxFeePct: 1.2, checkedAt: "2026-01-15", note: "€0,15 en 1,2% valutakoersopslag per keer. Bron: bank.nl-vergelijking, laatst gecontroleerd 2026-01-15." },
    { bank: "ABN AMRO", card: "creditcard", fxFeePct: 2, checkedAt: "2026-01-15", note: "Gratis + 2,0% valutakoersopslag per keer. Bron: bank.nl-vergelijking, laatst gecontroleerd 2026-01-15." },
    { bank: "ING", card: "betaalpas", fxFeePct: 1.4, checkedAt: "2026-01-15", note: "1,4% koersopslag. Bron: bank.nl-vergelijking, laatst gecontroleerd 2026-01-15." },
    { bank: "ING", card: "creditcard", fxFeePct: 2, checkedAt: "2026-01-15", note: "2,0% koersopslag. Bron: bank.nl-vergelijking, laatst gecontroleerd 2026-01-15." },
    { bank: "Rabobank", card: "betaalpas", fxFeePct: 1.4, checkedAt: "2026-01-15", note: "1,4% koersopslag. Bron: bank.nl-vergelijking, laatst gecontroleerd 2026-01-15." },
    { bank: "Rabobank", card: "creditcard", fxFeePct: 2, checkedAt: "2026-01-15", note: "2,0% koersopslag. Bron: bank.nl-vergelijking, laatst gecontroleerd 2026-01-15." },
    { bank: "ASN Bank", card: "betaalpas", fxFeePct: 1.4, checkedAt: "2026-01-15", note: "1,4% koersopslag. Bron: bank.nl-vergelijking, laatst gecontroleerd 2026-01-15." },
    { bank: "ASN Bank", card: "creditcard", fxFeePct: 2, checkedAt: "2026-01-15", note: "2,0% koersopslag. Bron: bank.nl-vergelijking, laatst gecontroleerd 2026-01-15." },
    { bank: "Triodos Bank", card: "betaalpas", fxFeePct: 1, checkedAt: "2026-01-15", note: "1,0% koersopslag; de buitenlandse bank kan hier nog kosten bovenop rekenen. Bron: bank.nl-vergelijking, laatst gecontroleerd 2026-01-15." },
    { bank: "Knab", card: "betaalpas", fxFeePct: 1.4, checkedAt: "2026-01-15", note: "1,4% koersopslag. Bron: bank.nl-vergelijking, laatst gecontroleerd 2026-01-15." },
    { bank: "Knab", card: "creditcard", fxFeePct: 2, checkedAt: "2026-01-15", note: "2,0% koersopslag. Bron: bank.nl-vergelijking, laatst gecontroleerd 2026-01-15." },
    { bank: "Bunq", card: "betaalpas", fxFeePct: 2, checkedAt: "2026-01-15", note: "Per abonnement — Bunq Core: 1,5% + 0,5% netwerkkosten; Bunq Pro: 0,5% netwerkkosten; Bunq Elite: 0,5% netwerkkosten. Hier is het duurste aangehouden (2%); corrigeer dit als je een ander abonnement hebt. Bron: bank.nl-vergelijking, laatst gecontroleerd 2026-01-15." },
  ],
};
