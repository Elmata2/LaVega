...
| Rabobank | `rabobank` | favicon (ander eigen host) | 1150 | 2026-08-20 | https://bankieren.rabobank.nl/favicon.ico |
...
- **RegioBank** — zelfde de Volksbank-icoon als SNS en ASN — identificeert het merk niet
- **Revolut** — https://www.revolut.com/favicon.ico → niet bereikbaar
