...
2. **De grootste post van het CBS is geen banktransactie.** "Toegerekende huur
   ...
   en is een *rekenkundige* huurwaarde voor mensen met een koophuis. Er staat
...
categorie *per huishoudtype* geeft. Drie levende tabellen:
...
| Huisdieren | 09.3.4 producten + 09.3.5 diensten | **ja** | €233/jr gemiddeld = €19/mnd. Netjes koppelbaar. Maar: gemiddeld over *alle* huishoudens, inclusief de meerderheid zonder huisdier. Voor iemand mét een hond is €19 geen zinnige lat. |
...
en een betrouwbaarheidsinterval *van dat gemiddelde*. Een percentiel valt er dus
...
1. **Er is geen verdeling, dus er is geen percentiel.** Het CBS publiceert per
   ...
   Geen mediaan, geen decielen van de *uitgaven*. Een percentiel uitrekenen vergt
...
4. **Het cijfer is zes jaar oud, uit een uitzonderlijk jaar, en blijft dat tot eind
   2027.** Elke correctie die je erop loslaat (CPI-indexatie, terug naar 2015)
...
actueel. Maar (a) het is een *minimum* voor een verantwoord voedingspakket, geen
...
de kolommen per huishoudgrootte zijn berekend als *aandeel uit 85420NED × totaal
uit 85419NED*, want 85419NED geeft alleen hoofdgroepen en rondt af op €100.
...
| 04.2 Toegerekende huur eigen woning *(geen transactie)* | 5.597 | 466 | 3.115 | 260 | 6.528 | 544 |
...
| 07.1 Aankoop van voertuigen *(lompe post)* | 1.614 | 134 | 826 | 69 | 1.865 | 155 |
...
| 12.5 Verzekeringen *(excl. basispremie zorg)* | 1.180 | 98 | 708 | 59 | 1.343 | 112 |
...
| 04.2 Toegerekende huur *(geen transactie)* | 9.716 | 810 | 151 | 13 |
