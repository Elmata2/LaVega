...
See [LaVega investing dashboard](./DASHBOARD.md) for the complete dashboard contract. It replaces this file's former chart inventory and return requirements.

The former v1 ruling against zoom, pan, and brush was deliberately overturned by [Interaction model for the portfolio chart](https://github.com/Elmata2/LaVega/issues/77). Production charts use direct drag-to-zoom, chart-local wheel zoom, and typed date ranges. They do not use a separate brush strip.
