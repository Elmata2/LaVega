...
| `investing.price_coverage` | One per user and symbol          | Date window the price provider already answered, plus the listing and currency it quoted (migration 0015). |
