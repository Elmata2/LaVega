...
const NORMALISE_ADAPTER = [
  ...
  '    const b = bin[key] || {};',
  "    let data = typeof b.data === 'string' ? b.data : '';",
  '    if (!data && b.id && helpers && helpers.getBinaryDataBuffer) {',
  '      // Staat N8N_DEFAULT_BINARY_DATA_MODE op filesystem/s3/database, dan zit',
  '      // de PDF niet in het item maar ernaast. Dan halen we de bytes alsnog op.',
