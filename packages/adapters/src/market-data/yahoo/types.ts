...
export type YahooChartResponse = { chart?: { result?: YahooChartResult[]; error?: { description?: string } | null } };
...
export type YahooSearchResult = { symbol: string; name: string; exchange?: string; quoteType?: string };
