...
const FX_TERMS = /koersopslag|wisselkoers|valutakoers|vreemde valuta|buitenlands geld|currency conversion|exchange rate fee|foreign exchange/gi;
...
type Product = {
  product: string; issuer: string; termsUrl?: string; pdfUrl?: string;
